"""
Django settings for EmployeeDetailsPage project.
...
SECRET_KEY = 'django-insecure-^1yqecu%hrp3_6ozv09kzs8g1rkadf^&4b*+%(n58c=w$!ese#'
...
ROOT_URLCONF = 'EmployeeDetailsPage.urls'
